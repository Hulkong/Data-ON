      ...
      <div class="list" v-if="getCount(getCategory+'_count') > 0">
        ...
        >
          ...
          <div class="con info">
            ...
            <div
              class="graph"
              v-if="docW >= 840 && item.tbresultEvaluation !== undefined && item.tbresultEvaluation !== null"
            >
              <chart-radar
                :radarId="item.id"
            ...
            <div class="inups" @click="openDetail(item.id, item.dt_type)">
              ...
              <p
                ...
                v-html="'<strong>'+item.dt_level+'</strong>'+item.dt_title"
              ></p>
            ...
            <div class="btns">
              ...
              <a
                v-if="item.tbattachFiles !== undefined && item.tbattachFiles.length > 0 && item.dt_type"
                href="javascript:void(0);"
          ...
          <transition name="slide">
            <div class="con detail" v-show="chkDetail(item.id)" :class="'detail_'+item.id">
              <!-- s: 평가 -->
              <div
                class="apprs"
              ...
              <!-- e: 메타 -->
              <!-- s: 컬럼설명 -->
              <include-detail-column :info="item.tblistColumns"></include-detail-column>
              <!-- e: 컬럼설명 -->
            </div>
          </transition>
          <!-- e : con -->
