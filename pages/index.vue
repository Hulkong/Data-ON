  ...
  <div id="contents">
    ...
    <div class="msec-01">
      <div class="div-cont">
        <div class="minit">
          <h1 class="logo">
            <a href="/"><span class="blind">Data-on</span></a>
          </h1>
          <nuxt-link to="/notice" class="bt-notice"
            ><span>공지사항</span></nuxt-link
          >
        </div>
        <h3>
          <span class="typing-txt"
            >누구나 쉽게 찾고 <br />활용하는 데이터플랫폼</span
          >
        </h3>
        <div class="search">
          <p class="chk-input">
            <input
              ...
              :placeholder="
                docW < 1000
                  ? '데이터를 검색 해보세요'
                  : '대한민국의 모든 데이터를 한곳에서 검색 해보세요'
              "
              v-model="keyword"
              @keyup.enter="goSearch"
            />
            <button class="enter" @click="goSearch">
    ...
    <div class="msec-02">
      <div class="div-cont">
        <h3>
          <span>Data-ON</span>에서는 데이터통합의 기준이 되는 행정경계,
          표준코드체계 파일을 제공합니다.
        </h3>
        <div class="con">
          <div class="item areas">
            <div class="tit read over">
              ...
              <div class="tooltip" v-show="regionPop">
                <p>
                  행정안전부에서 공개하는 도로명주소 전자지도
                  정보(www.juso.go.kr)와 통계청
                  통계지리정보서비스(sgis.kostat.go.kr)에서 제공하는 행정동 경계
                  파일을 기반으로 변경 이력을 반영한
                  파일(github.com/vuski/admdongkor)을 제공합니다.
                </p>
              </div>
            </div>
            <div
              class="txt"
              v-if="getResult('region') && getResult('region').length > 0"
            >
              <ul>
            ...
            <div class="txt" v-else>
              <ul>
                <li>
                  <span class="noData">등록된 표준코드 체계가 없습니다.</span>
                </li>
              </ul>
            </div>
          ...
          <div class="item codes">
            <div class="tit read over">
              ...
              <div class="tooltip over" v-show="stdrPop">
                <p>
                  통계분류포털(kssc.kostat.go.kr)에서 제공하는 행정구역분류
                  총괄표에 제시된 행정구역별 코드와 표준 명칭을 엑셀파일로
                  제공합니다. 행정구역 수준에 따라 시트(sheet)로 분리하여 코드를
                  제공하며, 결합할 수 있는 가장 높은 수준의 행정구역코드까지
                  제공합니다.
                </p>
              </div>
            </div>
            <div
              class="txt"
              v-if="getResult('stdr') && getResult('stdr').length > 0"
            >
              <ul>
          ...
          <div class="item notice">
            <div class="tit">
              <h4>공지사항</h4>
              <nuxt-link to="/notice" class="more"
                ><span>+ 더 보기</span></nuxt-link
              >
            </div>
            <div class="list">
          ...
          <ul>
            <li>
              <div>
                <div class="ico">
                  <p class="desktop">
                    <img src="/images/Main/why-ico01.png" alt="" />
                  </p>
                  <p class="mobile">
                    <img src="/images/Main/why-ico01m.png" alt="" />
                  </p>
                </div>
                <div class="utxt">
                ...
                <div class="btxt desktop">
                  <p>
                    AA빅데이터 플랫폼, <br />OO빅데이터 센터,<br />XX빅데이터
                    거래소 …
                  </p>
                  <p class="mg30t">
                    내가 원하는 데이터를 <br />한곳에서 검색 할 순 없을까?
                  </p>
                </div>
                <div class="btxt mobile">
                  <p>
                    AA빅데이터 플랫폼, OO빅데이터 센터..<br />내가 원하는
                    데이터를<br />한곳에서 검색 할 순 없을까?
                  </p>
                </div>
              </div>
            </li>
            <li>
              <div>
                <div class="ico">
                  <p class="desktop">
                    <img src="/images/Main/why-ico02.png" alt="" />
                  </p>
                  <p class="mobile">
                    <img src="/images/Main/why-ico02m.png" alt="" />
                  </p>
                </div>
                <div class="utxt">
                ...
                <div class="btxt desktop">
                  <p>
                    찾았다! 하면 링크로 연결… <br />다운로드! 하면 <br />포멧도
                    단위도 시점도 제각각
                  </p>
                  <p class="mg30t">
                    데이터 전처리에만 80%의 <br />시간을 쓰게 됩니다.
                  </p>
                </div>
                <div class="btxt mobile">
                  <p>
                    찾았다! 하면 링크로 연결… <br />다운로드! 하면 포멧도 단위도
                    시점도 제각각<br />데이터 전처리에만 80%의 시간을 쓰게
                    됩니다.
                  </p>
                </div>
              </div>
            ...
            <li>
              <div>
                <div class="ico">
                  <p class="desktop">
                    <img src="/images/Main/why-ico03.png" alt="" />
                  </p>
                  <p class="mobile">
                    <img src="/images/Main/why-ico03m.png" alt="" />
                  </p>
                </div>
                <div class="utxt">
                ...
                <div class="btxt desktop">
                  <p>라떼는 말이야…</p>
                  <p class="mg30t">
                    ‘경험’과 ‘직관’을 넘어 <br />데이터로 미래를 예측하고
                    <br />변화를 분석하는 것은 <br />‘선택이 아닌 필수’가
                    되었습니다.
                  </p>
                </div>
                <div class="btxt mobile">
                  <p>
                    라떼는 말이야…‘경험’과 ‘직관’을 넘어 <br />데이터로 미래를
                    예측하고 변화를 분석 하는 것은 <br />
                    ‘선택이 아닌 필수’가 되었습니다.
                  </p>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...mapActions("mainList", ["getData","addStdrDownCnt"]),
    ...
    goSearch: function () {
      ...
      // 구글 애널리틱스 추가
      if (this.$deviceChk())
        this.$sendGA(this, "메인검색_mobile", "검색", searchKey);
