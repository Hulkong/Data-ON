<template>
    <div class="paging-wrap">
        ...
        <a  href="javascript:void(0);" 
            v-if="totalCount > (listsize * cpage) && totalCount > (listsize * pListCount)" 
            @click="goNext"
            class="next ctrl">
    ...
    computed: {
        ...
        pageListCnt: function(){
            ...
            if((this.totalCount/this.listsize) <= this.pListCount){
                ...
                return Math.ceil((thisListCnt - this.totalCount)/this.listsize);
            } else {
